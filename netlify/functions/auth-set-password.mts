...
import { setUserPassword, userFromRequest } from './_shared/auth.mts'
import { bodyOf, internalError, json, methodNotAllowed } from './_shared/http.mts'
import { PASSWORD_MAX_LENGTH, PASSWORD_MIN_LENGTH } from './_shared/security.mts'
...
export const config: Config = { path: '/api/auth/set-password', method: 'POST' }
